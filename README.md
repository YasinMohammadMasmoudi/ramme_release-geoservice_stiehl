# Rammsondierung — Releases (Geoservice Stiehl)

Öffentlicher Auslieferungskanal für die App **Rammsondierung** von Geoservice Stiehl.
Der Quellcode liegt privat in [`ramme-geoservice_stiehl`](https://github.com/YasinMohammadMasmoudi/ramme-geoservice_stiehl).
...
2. Hier ein Release `vX.Y.Z` anlegen und `rammsondierung.apk` als Asset anhängen.
